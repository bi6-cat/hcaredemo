...
public class DoctorAppointmentController {
    ...
    public DoctorAppointmentController(HealthCheckAppointmentService healthCheckAppointmentService, DoctorRepository doctorRepository, UserRepository userRepository, MedicineService medicineService) {
